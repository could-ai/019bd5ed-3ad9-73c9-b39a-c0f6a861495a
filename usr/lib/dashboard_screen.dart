    ...
    PresentationSection(
      ...
      slides: [
        ...
        SlideData(
          ...
          objective: "Explicar detalhadamente o processo de construção e validação do modelo.",
          visuals: "Gráfico ACF/PACF da série diferenciada (como na imagem) + Tabela AIC/BIC.",
          points: [
            "METODOLOGIA (BOX-JENKINS):",
            "• Seguimos rigorosamente os passos: Identificação, Estimação e Verificação.",
            "",
            "1. ESTACIONARIEDADE (PREPARAÇÃO):",
            "• A série original não era estacionária (tinha tendência e variância instável).",
            "• Aplicámos Logaritmo para estabilizar a variância.",
            "• Aplicámos Diferenças: Uma regular (d=1) para remover a tendência e uma sazonal (D=1, s=52) para a sazonalidade.",
            "• O gráfico da série diferenciada (topo) mostra agora oscilações em torno de zero, confirmando a estacionariedade.",
            "",
            "2. IDENTIFICAÇÃO (ACF/PACF):",
            "• Analisámos os correlogramas (ACF e PACF) da série estacionária.",
            "• Observámos picos significativos nos primeiros lags e nos lags sazonais (52), sugerindo a necessidade de componentes AR e MA.",
            "",
            "3. SELEÇÃO DO MODELO (AIC/BIC):",
            "• Testámos vários modelos candidatos baseados na leitura dos gráficos.",
            "• O modelo vencedor foi o SARIMA(1,1,1)(0,1,1)[52].",
            "• Porquê? Apresentou os menores valores de AIC e BIC, indicando o melhor equilíbrio entre ajuste aos dados e simplicidade.",
            "",
            "4. VALIDAÇÃO (DIAGNÓSTICO):",
            "• Validámos os resíduos com o teste Ljung-Box.",
            "• Resultado: p-value > 0.05, logo não rejeitamos a hipótese nula.",
            "• Conclusão: Não há autocorrelação nos resíduos. O que sobra é apenas 'ruído branco' (aleatório), confirmando que o modelo extraiu toda a estrutura relevante da série.",
          ],
        ),
        SlideData(
